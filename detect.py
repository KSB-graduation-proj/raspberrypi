...
#model_name = '/home/ksb/yolov5/best0518.pt'
#model_name = '/home/ksb/best.pt'
...
def capture(key):
    ...
    for x in range(capture_cnt):
        ...
        capture_lst.append(img_path)
    
    print('You may take your products')
    
    for img_path in capture_lst:
        print(img_path)
